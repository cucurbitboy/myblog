      ...
      >
        <div class="list">
          ...
          <div @click="handleClickMenu('/articles')" class="item">
            <router-link to="/articles">网站</router-link>
          </div>
          <div @click="handleClickMenu('/archive')" class="item">
            <router-link to="/archive">动 态</router-link>
          </div>
          <div @click="handleClickMenu('/project')" class="item">
            <router-link to="/project">APP案例</router-link>
          </div>
          ...
          <div @click="handleClickMenu('/message')" class="item">
            <router-link to="/message">下 单</router-link>
          </div>
          ...
          <div v-if="!userInfo._id" @click="handleClickMenu('/register')" class="item">注 册</div>
          <div v-if="userInfo._id" @click="handleClickMenu('/logout')" class="item">登 出</div>
        </div>
      </div>
    </div>
    <div
...
export default class Nav extends Vue {
  ...
  logo: string = require("../assets/logo.jpg");
  handleFlag: string = "";
  title: string = "首页";
  list: Array<object> = [
    {
